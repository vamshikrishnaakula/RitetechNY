...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rite Tech Construction | Professional Builder Portfolio" },
      { name: "description", content: "Professional builder portfolio for construction, renovation, remodeling, structural work, finishing, and project coordination." },
      { property: "og:title", content: "Rite Tech Construction | Professional Builder Portfolio" },
      { property: "og:description", content: "Construction portfolio shaped by Oman industry experience, American-standard execution, and dependable workmanship." },
      ...
      { name: "twitter:title", content: "Rite Tech Construction | Professional Builder Portfolio" },
      { name: "twitter:description", content: "Professional builder portfolio for construction, renovation, remodeling, structural work, finishing, and project coordination." },
