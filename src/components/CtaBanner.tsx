    ...
    <section className="container mx-auto px-6 py-20">
      <div className="relative overflow-hidden rounded-sm bg-navy text-navy-foreground p-12 md:p-16 text-center">
        ...
        <div className="relative">
          <p className="text-primary font-semibold tracking-widest text-xs uppercase mb-3">Let's build professionally</p>
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Ready to plan your next construction project?</h2>
          <p className="max-w-2xl mx-auto opacity-80 mb-8">
            Share your scope with Rite Tech and work with a builder focused on clear planning, durable execution, and professional handover.
          </p>
